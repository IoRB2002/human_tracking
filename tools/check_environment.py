...
def main():
    ...
    required_apis = {
        ...
        "PoseLandmarkerOptions": report_api(
            vision,
            "PoseLandmarkerOptions",
        ),
        "HandLandmarker": report_api(vision, "HandLandmarker"),
        "HandLandmarkerOptions": report_api(
            vision,
            "HandLandmarkerOptions",
        ),
        "HolisticLandmarker": report_api(
            vision,
            "HolisticLandmarker",
        ),
        "HolisticLandmarkerOptions": report_api(
            vision,
    ...
    if essential:
        ...
        print(
            "Pose + Hand MediaPipe Tasks APIs are available "
            "in this environment."
        )

        if (
            required_apis["HolisticLandmarker"]
            and required_apis["HolisticLandmarkerOptions"]
        ):
            print("Holistic Landmarker API is also available.")
        else:
            print(
                "Holistic Landmarker API is not exposed here; "
                "Pose + Hand remain available."
            )
